...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r tomcat
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r tomcat -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-tomcat
cd docker-tomcat
...
| --- | --- | --- | --- |
| tomcat | 9091 | HTTP/HTTPS Proxy port | Y |
## Documentation

[Tomcat  Administrator Guide](https://support.websoft9.com/docs/tomcat)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Tomcat  Enterprise Support](https://apps.websoft9.com/tomcat) 
